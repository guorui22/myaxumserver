...
mod test {
    ...
    fn test_get_claims() {
        let jwt = Jwt::new(SECRET.to_string(), 120, ISS.to_string());
        let token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6MSwiZW1haWwiOiJ0ZWFtQGF4dW0ucnMiLCJpc3MiOiLlnKPlhpzpm4blm6IiLCJleHAiOjE2OTk2MDc5NDQ1MDJ9.Y7CqsokJIxzF8bKVMrFWrR-ltbRnc2jdGT0ms5xY3Xk";
